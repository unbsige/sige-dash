...
class CSISolarOAuthClient:
    ...
    def login(self, username, password):
        ...
        password_hash_nav = "8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92"
        if password_hash != password_hash_nav:
            print("✗ Hash de senha não corresponde ao esperado")
            return False
        ...
        try:
            return self._execute_login_request(oauth_url, login_data, login_headers)
        except httpx.RequestError as e:
            print(f"✗ Erro na requisição de login: {e}")
            return False

    def _execute_login_request(self, oauth_url, login_data, login_headers):
        response = self.client.post(oauth_url, data=login_data, headers=login_headers)
    ...
    def refresh_access_token(self):
        ...
        refresh_data = {"grant_type": "refresh_token", "refresh_token": self.refresh_token}
        oauth_url = f"{self.base_url}/home/oauth-s/oauth/token"
